...
public class DetailapprenantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            // this function place all information with ID
        } catch (JSONException e) {
            Toast.makeText(this, "Erreur : "+e,
                    Toast.LENGTH_LONG)
                    // Set duration TOAST long time
                    .show();
            //Display toast
        }

        String url = "https://randomuser.me/api/";
        // get Json information with API
        ...
        retour.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                //Intent provide runtime between two components separate
